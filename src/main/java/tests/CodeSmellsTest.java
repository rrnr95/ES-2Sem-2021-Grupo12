...
public class CodeSmellsTest {
	...
	public void testInit() {
		...
		expected_SR.addMethod(new MethodStats(
				0, "pack3", System.getProperty("user.dir")+ "\\TestProject\\src\\pack3\\ClassInPack3", ic, "main(String[])", 3, 1, 1, 6, 1, "false", "false"
				));
		ic = new ArrayList<>();
		ic.add("ClassInPack2");
		expected_SR.addMethod(new MethodStats(
				0, "pack2", System.getProperty("user.dir")+ "\\TestProject\\src\\pack2\\ClassInPack2", ic, "getAttribute1()", 3, 1, 2, 13, 2, "false", "false"
				));
		expected_SR.addMethod(new MethodStats(
				0, "pack2", System.getProperty("user.dir")+ "\\TestProject\\src\\pack2\\ClassInPack2", ic, "setAttribute1(int)", 3, 1, 2, 13, 2, "false", "false"
				));
		ic = new ArrayList<>();
		ic.add("ClassInPack1");
		expected_SR.addMethod(new MethodStats(
				0, "pack1", System.getProperty("user.dir")+ "\\TestProject\\src\\pack1\\ClassInPack1", ic, "getAttribute1()", 3, 1, 4, 23, 5, "true", "false"
				));
		expected_SR.addMethod(new MethodStats(
				0, "pack1", System.getProperty("user.dir")+ "\\TestProject\\src\\pack1\\ClassInPack1", ic, "setAttribute1(String)", 5, 2, 4, 23, 5, "true", "false"
				));
		expected_SR.addMethod(new MethodStats(
				0, "pack1", System.getProperty("user.dir")+ "\\TestProject\\src\\pack1\\ClassInPack1", ic, "getAttribute2()", 3, 1, 4, 23, 5, "true", "false"
				));
		expected_SR.addMethod(new MethodStats(
				0, "pack1", System.getProperty("user.dir")+ "\\TestProject\\src\\pack1\\ClassInPack1", ic, "setAttribute2(String)", 3, 1, 4, 23, 5, "true", "false"
				));
